...
export default class Inventory {
    ...
    search(idealGuitar) {
        ...
        for (const guitar of this.guitars) {
            if (guitar.serialNumber === serialNumber && guitar.price <= price && guitar.builder === builder && guitar.model === model && guitar.type === type && guitar.backwood === backwood && guitar.topwood === topwood) {
                return guitar;
            }
        }
        return null;
